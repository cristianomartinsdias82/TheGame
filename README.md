...
1. Invoke a couple of times the endpoint 1. You can use a tool like Postman or Advanced REST Client to send some requests tho the aforementioned application endpoint 1.<br/>
